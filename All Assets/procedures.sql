-- ============================================================================
-- TOUTES LES PROCÉDURES STOCKÉES - IES
-- ============================================================================
-- Ce fichier contient toutes les procédures stockées du projet IES
-- Incluant les procédures standard et personnalisées
-- 
-- STRUCTURE:
-- 1. Procédures personnalisées (gestion utilisateurs)
-- 2. Procédures standards (historique BL, détails, etc)
-- ============================================================================
...
-- =====================================================
-- Procédures Stockées Personnalisées pour Gestion Utilisateurs
-- =====================================================

-- Procédure pour récupérer tous les utilisateurs clients (excluant les utilisateurs supprimés)
-- Inclut les codes tiers liés via la table customerusers_thirdparty en format JSON
-- Columns: Id, UserName, FirstName, LastName, Site, CompanyName, CompanyAddress, PhoneNumber, 
--          CellPhone, AccountType, Status, CustomerUsersStatusId, CustomerUsersTypeId, ThirdPartyCodes
...
-- Procédure pour récupérer tous les clients (ConsigneeId) ayant des BLs
-- Exclut les utilisateurs avec le statut Supprimé (ID: 5)
...
-- Procédure pour activer/désactiver un utilisateur
...
-- Procédure pour mettre à jour les codes tiers d'un utilisateur
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateCustomUserInfo`(
    ...
    IN `p_CompanyAddress` VARCHAR(500),
