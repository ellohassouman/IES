...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 13 déc. 2025 à 22:38
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetCartByUserId` (IN `p_CustomerUserId` INT)  BEGIN
                ...
                LEFT JOIN invoice inv ON ci.InvoiceId = inv.Id AND inv.Deleted = 0
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateInvoiceStatus` (IN `p_InvoiceId` INT, IN `p_StatusId` INT)  BEGIN
        ...
        SET StatusId = p_StatusId,
            ValIdationDate = NOW(),
            InvoiceNumber = COALESCE((SELECT MAX(InvoiceNumber) FROM invoice), 0) + 1
        WHERE Id = p_InvoiceId AND Deleted = 0;
...
(1, 251000001, '2025-12-13 00:00:00', '7414', '1482', '8896', 5, 3, 0),
(2, 251000002, '2025-12-13 00:00:00', '5577', '1115', '6692', 6, 3, 0),
(3, NULL, '2025-07-23 00:00:00', '3139', '627', '3766', 7, 1, 0),
(4, 251000004, '2025-01-09 00:00:00', '5835', '1167', '7002', 8, 3, 0),
(5, 251000005, '2025-05-12 00:00:00', '4608', '921', '5529', 9, 3, 0),
...
(505, NULL, NULL, '8767', '1753', '10520', 10, 1, 0),
(506, NULL, '2025-12-13 00:00:00', '8738', '1747', '10485', 11, 1, 0),
